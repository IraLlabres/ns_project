...
{   ?>
                                                    ...
                                                    <div class="form-group has-primary">
                                                        <label for="primary" class="control-label">Class Name</label>
                                                		<div class="">
                                                       ...
                                                       <div class="form-group has-primary">
                                                        <label for="primary" class="control-label">Class Name in Numeric</label>
                                                        <div class="">
                                                     ...
                                                     <div class="form-group has-primary">
                                                        <label for="primary" class="control-label">Section</label>
                                                        <div class="">
  ...
  <div class="form-group has-primary">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="update" class="btn btn-primary btn-labeled">Update<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div>
