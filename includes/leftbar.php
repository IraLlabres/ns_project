<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <h6 class="title">Vince Diaz</h6>
                                <h6 class="title">Jewel Rose Lorejas</h6>
                                <h6 class="title">Ira Lorenzo Llabres</h6>
                                <h6 class="title">Wenllie Joyce Suyat</h6>
  ...
  <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                           ...
                                           <li><a href="add-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Assign Subject to a Section </span></a></li>
                                           <a href="manage-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Subject to a Section </span></a></li>
                                        </ul>
                                    </li>
   <li class="has-children">
