 ...
 <strong>Well done!</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form  name="chngpwd" method="post" \ onSubmit="return valid();">
                                                    <div class="form-group has-primary">
                                                        <label for="primary" class="control-label">Current Password</label>
                                                		<div class="">
                                    <input type="password" name="password" class="form-control" required="required" id="success">
                                                       ...
                                                       <div class="form-group has-primary">
                                                        <label for="primary" class="control-label">New Password</label>
                                                        <div class="">
                                                            <input type="password" name="newpassword" required="required" class="form-control" id="success">
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-primary">
                                                        <label for="primary" class="control-label">Confirm Password</label>
                                                        <div class="">
  ...
  <div class="form-group has-primary">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="submit" class="btn btn-primary btn-labeled">Change<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div>
