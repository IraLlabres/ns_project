                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php $sql = "SELECT  distinct tblresult.StudentId,tblresult.ClassId,tblresult.SubjectId,tblresult.marks,tblresult.PostingDate,tblresult.UpdationDate from tblresult join tblstudents on tblstudents.StudentId=tblresult.StudentId  join tblclasses on tblclasses.id=tblresult.ClassId";
